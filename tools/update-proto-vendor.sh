...
extract_urls ../target/proto-vendor-src \
    https://github.com/celestiaorg/celestia-app/archive/refs/tags/v3.0.0-mocha.tar.gz \
...
cp -r ../target/proto-vendor-src/celestia-app-3.0.0-mocha/proto/celestia vendor
