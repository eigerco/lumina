...
## [0.6.0](https://github.com/eigerco/lumina/compare/celestia-rpc-v0.5.0...celestia-rpc-v0.6.0) - 2024-10-09

### Fixed

- [**breaking**] fix!(rpc): use correct blob type in state submit pay for blob ([#418](https://github.com/eigerco/lumina/pull/418))
