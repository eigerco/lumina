...
async fn blob_submit_and_get_all() {
    ...
    let blobs = &[
        Blob::new(namespaces[0], random_bytes(5), AppVersion::V1).unwrap(),
        Blob::new(namespaces[1], random_bytes(15), AppVersion::V1).unwrap(),
    ];
...
async fn blob_subscribe() {
    ...
    let blob = Blob::new(namespace, random_bytes(10), AppVersion::V1).unwrap();
    ...
    let blob_another_ns = Blob::new(random_ns(), random_bytes(10), AppVersion::V1).unwrap();
    ...
    let blob1 = Blob::new(namespace, random_bytes(10), AppVersion::V1).unwrap();
    let blob2 = Blob::new(random_ns(), random_bytes(10), AppVersion::V1).unwrap(); // different ns
    let blob3 = Blob::new(namespace, random_bytes(10), AppVersion::V1).unwrap();
